var loadSearchPaths = function () {
    var downloaderrorKey = localStorage.getItem('DOWNLOAD_FILE_ERROR_KEY');
    if (downloaderrorKey) {
        var spath = jsb.fileUtils.getWritablePath() + 'game-remote-asset'
        if (jsb.fileUtils.isDirectoryExist(spath)) {
            jsb.fileUtils.removeDirectory(spath)
        }
        localStorage.removeItem('DOWNLOAD_FILE_ERROR_KEY')
    }
