...
export default class MD5 {
     ...
     */
    public static hex_md5(s) { return MD5.rstr2hex(MD5.rstr_md5(MD5.str2rstr_utf8(s))); }//这个函数就行了，
    public static b64_md5(s) { return MD5.rstr2b64(MD5.rstr_md5(MD5.str2rstr_utf8(s))); }
    public static any_md5(s, e) { return MD5.rstr2any(MD5.rstr_md5(MD5.str2rstr_utf8(s)), e); }
    public static hex_hmac_md5(k, d) { return MD5.rstr2hex(MD5.rstr_hmac_md5(MD5.str2rstr_utf8(k), MD5.str2rstr_utf8(d))); }
    private static b64_hmac_md5(k, d) { return MD5.rstr2b64(MD5.rstr_hmac_md5(MD5.str2rstr_utf8(k), MD5.str2rstr_utf8(d))); }
    private static any_hmac_md5(k, d, e) { return MD5.rstr2any(MD5.rstr_hmac_md5(MD5.str2rstr_utf8(k), MD5.str2rstr_utf8(d)), e); }
    ...
    */
    public static rstr2hex(input) {
        try { MD5.hexcase } catch (e) { MD5.hexcase = 0; }
    ...
    */
    public static rstr2b64(input) {
        try { MD5.b64pad } catch (e) { MD5.b64pad = ''; }
    ...
    * For efficiency, MD5 assumes the input is valid utf-16.
    */
    ...
    */
    ...
    /*
    * Add integers, wrapping at 2^32. MD5 uses 16-bit operations internally
